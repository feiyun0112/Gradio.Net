const __vite__fileDeps=["./index.DuV3kDhS.js","./index.BNvx-E6Z.js","./index.MeclqTAq.js","./index.BegVs0KM.js","./index.Cg6yJ_N6.js","./index.Jixb5Id5.js","./frontmatter.VFvlf3RN.js","./yaml.BMKOA8H-.js","./index.BVSHEBPR.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { I as IconButton, q as Check, r as Copy$1, B as Block, S as Static } from "./2.BqWhUxOo.js";
...
const lang_map = {
  python: () => __vitePreload(() => import("./index.DuV3kDhS.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      __vitePreload(() => import("./index.MeclqTAq.js"), true ? __vite__mapDeps([2,3,1,4,5]) : void 0, import.meta.url),
      __vitePreload(() => import("./frontmatter.VFvlf3RN.js"), true ? __vite__mapDeps([6,7]) : void 0, import.meta.url)
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => __vitePreload(() => import("./index.BVSHEBPR.js"), true ? __vite__mapDeps([8,1]) : void 0, import.meta.url).then((m) => m.json()),
  html: () => __vitePreload(() => import("./index.BegVs0KM.js"), true ? __vite__mapDeps([3,1,4,5]) : void 0, import.meta.url).then((m) => m.html()),
  css: () => __vitePreload(() => import("./index.Cg6yJ_N6.js"), true ? __vite__mapDeps([4,1]) : void 0, import.meta.url).then((m) => m.css()),
  javascript: () => __vitePreload(() => import("./index.Jixb5Id5.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then((m) => m.javascript()),
  jinja2: () => __vitePreload(() => import("./jinja2.2Vo2sGef.js"), true ? [] : void 0, import.meta.url).then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => __vitePreload(() => import("./index.Jixb5Id5.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then(
