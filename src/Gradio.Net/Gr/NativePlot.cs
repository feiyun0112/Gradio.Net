...
{
    public static NativePlot NativePlot(
        object value = null,
        string x = null,
        string y = null,
        string color = null,
    ...
    {
        return new LinePlot(
            value: value, x: x, y: y, color: color, title: title, xTitle: xTitle, yTitle: yTitle,
